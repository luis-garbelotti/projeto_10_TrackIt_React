...
export default function CheckBoxToday({ habit, setChecked, checked }) {
    ...
    return (
        <>
            ...
            <Checkbox habitDone={habit.done} onClick={checkDone /* !checked ? setChecked(true) : setChecked(false) */}>
